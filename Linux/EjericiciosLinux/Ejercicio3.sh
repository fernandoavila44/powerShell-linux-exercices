...
echo "Obteniendo datos de la publicación ID: $idPublicacion..."
response=$(curl -s https://jsonplaceholder.typicode.com/posts/$idPublicacion)
...
echo "Datos de la publicación ID: $idPublicacion"
