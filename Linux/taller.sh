 ...
 #1. Realiza una solicitud GET a la API jsonplaceholder.typicode.com/users y utiliza jq para 
 #formatear y mostrar la lista de usuarios.
...
#echo "$response" | jq .
 ...
 #2. Realiza una solicitud GET a la API jsonplaceholder.typicode.com/posts y utiliza jq para 
 #filtrar y mostrar solo los títulos de las publicaciones.
